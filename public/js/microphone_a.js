...
function startCapture() {
  ...
  console.log(`startCapture: supported: ${supported}`);
  if (supported) {
    gUM_startCapture();
    return;
  }
...
function gUM_startCapture() {
    console.log(`gUM_startCapture`);
    var codec = new Speex({ quality: 6 });

    function onmicaudio (samples) {
        // console.log(`onmicaudio:`, samples);
        var encoded, decoded;
    ...
    function callback (_fn) {
        ...
        return function (stream) {
            ...
            console.log(`gUM_startCapture: callback: connect mic->processor->destination`);
            mic.connect(processor);
            processor.connect(audioContext.destination);

            // console.log(`gUM_startCapture: callback: connect mic->destination`);
...
//     console.log(`flash_startCapture`);
//     // quality = 2; nb = 15
//     // quality = 4; nb = 20
//     // quality = 6; nb = 28
//     // quality = 8; nb = 38
...
//     console.log(`flash_startCapture: sink["mozSetup"]: ${sink["mozSetup"]}`);
//     console.log(`flash_startCapture: sink["mozWriteAudio"]: ${sink["mozWriteAudio"]}`);
